...
apt-get update
apt-get install -y apache2 git curl php5-cli php5 php5-intl libapache2-mod-php5 mysql-server php5-mysql mysql-client
mysql -root < /wamp/www/cv3/data/init_bd.sql
echo "
<VirtualHost *:80>
